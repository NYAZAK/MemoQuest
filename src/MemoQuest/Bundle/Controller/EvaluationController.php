...
use MemoQuest\Bundle\Entity\Evaluation;
use MemoQuest\Bundle\Form\EvaluationType;

class EvaluationController extends FOSRestController implements ClassResourceInterface
{
    /**
    ...
    public function cgetAction(Request $request, $userId, $listeId)
    {
        ...
        $entities = $em->getRepository('MemoQuestBundle:Evaluation')->findBy(
            array(
                'liste' => $listeId,
            )
        );
    ...
    protected function getEntity($listeId, $id)
    {
        ...
        $entity = $em->getRepository('MemoQuestBundle:Evaluation')->findOneBy(
            array(
                'id' => $id,
                'liste' => $listeId,
            )
